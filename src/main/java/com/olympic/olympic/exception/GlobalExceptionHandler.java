...
/**
 * Manejo global de excepciones, mantenido ahora solo para el @RestController
 * que queda (UsuarioController). Las páginas Thymeleaf (PageController,
 * ProductoController, RecuperacionPasswordController) manejan sus propios
 * errores con try/catch + Model/RedirectAttributes, no con JSON — por eso
 * este advice se restringe a clases anotadas con @RestController, para que
 * no intercepte por accidente una página HTML y le devuelva JSON.
 */
